...
use testdb;
CREATE TABLE item (item_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, item_name VARCHAR(100) NOT NULL, qty_ordered INT NOT NULL, item_price DEC(7, 2) NOT NULL, item_category VARCHAR(100) NOT NULL);
